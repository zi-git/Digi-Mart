...
import { Heart, ShoppingCart, User, UserRoundPlus } from "lucide-react";
    ...
    <>
      ...
      >
        <div className="flex flex-col sm:flex-row sm:flex-wrap md:flex-nowrap justify-between w-full max-w-[1500px] items-center py-4 gap-y-3 gap-x-4 ">
          {/* Logo */}
          <h1 className="text-[var(--brand)] text-2xl md:text-3xl font-bold transition-all duration-300 hover:opacity-80 cursor-pointer text-center sm:text-left w-full sm:w-auto">
